...
export class AigPartecipationModalityNewUpdateFormComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        /*if (this.partecipationModality != null && this.partecipationModality.id != null) {
       ...
       // let partecipationModality: PartecipationModalityDTO = this.partecipationModalityNewUpdateForm.value;
        ...
        try {
            ...
            /*if (this.isUpdate) {
                ...
                await this.partecipationModalityResourceService.createPartecipationUsingPOST(partecipationModality).toPromise();
                postOrPut = "created";
            }
