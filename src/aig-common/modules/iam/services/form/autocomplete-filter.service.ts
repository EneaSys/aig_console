...
export class AigAutocompleteFilterService {
    ...
    filterSystemRole(observable: Observable<any>) {
        return observable.pipe(
            ...
            switchMap((value: string) => {
                if (value.length > 4) {
                    return this.roleResourceService.getAllRolesUsingGET(null, null, null, null, null, null, null, value, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 10, null);
                } else {
                    return of([]);
                }
            })
