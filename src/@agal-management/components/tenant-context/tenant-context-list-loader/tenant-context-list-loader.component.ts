...
@Component({
    selector: 'agal-tenant-context-list-loader',
    templateUrl: './tenant-context-list-loader.component.html',
    styleUrls: ['./tenant-context-list-loader.component.scss']
})
export class AgalTenantContextListLoaderComponent extends AgalGenericComponent implements OnInit {
	@Input()
    filters: any = {};
    ...
    constructor(
        private resourceService: TenantContextResourceService,
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllTenantContextsUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countTenantContextsUsingGET(filters).toPromise();
