...
import { LicenzeResourceService } from 'aig-management';

@Component({
    selector: 'agal-licenze-list-loader',
    templateUrl: './licenze-list-loader.component.html',
    styleUrls: ['./licenze-list-loader.component.scss']
})
export class AgalLicenzeListLoaderComponent extends AgalGenericComponent implements OnInit {
	@Input()
    filters: any = {};
    ...
    constructor(
        private resourceService: LicenzeResourceService,
    ...
    async loadData() {
        ...
        this.ds = await this.resourceService.getAllLicenzesUsingGET(filters).toPromise();
        
        this.totalRecords = await this.resourceService.countLicenzesUsingGET(filters).toPromise();
