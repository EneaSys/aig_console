...
//			---- SEARCH SECTION ----
	...
	newTableColumns: string[] = ['_ck','id','procurement.contractorEopoo','candidacy', 'procurementLot.description', 'procurementLot.cig', 'proposerEopoo','procurementLot.offerExpiryDate','procurementLot.baseAmount','status'];
	newTableButtons: any[] = [];
