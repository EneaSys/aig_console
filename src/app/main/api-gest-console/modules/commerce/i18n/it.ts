export const locale = {
    ...
    data: {
        'COMMERCE' : {
            'ADD' : 'aggiungi',
            'ADD_NEW_CATALOG_ITEM' : 'Aggiungi nuovo prodotto di catalogo',
            'BUYER' : 'cliente',
            'STATUS_NOTE' : 'note',
            'BUYERS' : 'clienti',
            ...
            'ITEMS_COMBINATIONS' : "combinazioni prodotti",
            ...
            'CATALOGS' : 'cataloghi',
            'CATALOGS_MANAGER' : 'gestore di cataloghi',
            'CATALOG' : 'catalogo',
            'CATALOG_PRICES_MANAGEMENT' : 'gestore prezzi catalogo',
