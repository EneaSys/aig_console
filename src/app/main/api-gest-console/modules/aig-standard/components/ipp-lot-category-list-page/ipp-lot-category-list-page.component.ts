...
import { AigLotCategoryDialogComponent } from 'aig-common/modules/standard/components/ipp-lot-category/lot-category-dialog-page/lot-category-dialog-page.component';
