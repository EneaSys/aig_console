...
@Component({
    templateUrl: './form-data-detail-page-2.component.html',
    styleUrls: ['./form-data-detail-page-2.component.scss']
})
export class AigFormDataDetailPage2Component extends GenericComponent {
    constructor(
