...
@Component({
    templateUrl: './form-data-detail-page-3.component.html',
    styleUrls: ['./form-data-detail-page-3.component.scss']
})
export class AigFormDataDetailPage3Component extends GenericComponent {
    constructor(
